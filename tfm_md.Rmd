...
circ <- as.data.frame(read.table("C:/Users/ainho/eccDNA/BED/SRR6315401_unknown_circle.bed",header = FALSE, sep="\t",stringsAsFactors=FALSE))

names(circ) <- c("chrom","start","end","discordant_reads","split_reads","score","coverage_mean","coverage_sd","coverage_start", "coverage_end","coverage_cont")

coords<- circ %>% dplyr::select(chrom,start,end) %>% makeGRangesFromDataFrame
